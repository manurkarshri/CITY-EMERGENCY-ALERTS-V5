export function classify(text){
  ...
  const rules=[
    {w:["red alert","school closed","schools closed","orange alert"],severity:"emergency",category:"weather",type:"Public Weather Alert",icon:"🚨",critical:true,action:"Follow official instructions and avoid unnecessary travel."},
    {w:["dam release","river overflow","flood warning","flood"],severity:"emergency",category:"flood",type:"Flood Alert",icon:"🌊",critical:true,action:"Avoid low-lying areas, river banks and flooded roads."},
    ...
    {w:["tree fall","wall collapse","waterlogging","disruption","delayed","cancelled"],severity:"watch",category:"impact",type:"Local Impact",icon:"⚠️",critical:false,action:"Be cautious in the affected area."}
  ];
