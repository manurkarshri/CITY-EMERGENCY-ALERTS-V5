...
export function ageText(v){const t=new Date(v).getTime();if(!t)return"Data: fallback";const m=Math.round((Date.now()-t)/60000);return m<1?"Data: just now":`Data: ${m} min old`}
